...
type GameKey = 'obby' | 'obby-tower' | 'sprint' | 'fraction' | 'snake' | 'shooter' | 'tug' | 'line-graph' | 'average' | 'angles'
...
function App() {
  ...
  const topicGames = useMemo(() => (['average', 'line-graph', 'sprint', 'fraction', 'snake', 'shooter', 'tug', 'angles'] as GameKey[]), [])
